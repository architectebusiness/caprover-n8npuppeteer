...
# Mettre la dernière version de N8N
ARG N8N_VERSION=0.198.2

# Vérifie si il existe une version de N8N dans le fichier actuel
RUN if [ -z "$N8N_VERSION" ] ; then echo "The N8N_VERSION argument is missing!" ; exit 1; fi

# Mise à jour et installation de toute les dépendance nécessaires 
RUN apk add --update graphicsmagick tzdata git tini su-exec

# # Mettre un autre nom que root (c'est un identifiant) 
USER root
